        ...
        {/* handle the onsubmit on form. */}
         <form className="space-y-6" onSubmit={handleForgetPasswordOnSubmit}>
            <div>
                ...
                <div className="mt-2">
                <input id="verify_email" name="verify_email" type="email" autoComplete="current-email" required onChange={(e)=>setVerify_Email(e.target.value)} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                </div>
            </div>
